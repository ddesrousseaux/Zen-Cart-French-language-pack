...
define('HEADER_ALT_TEXT', 'Admin d&eacute;velopp&eacute; par Zen Cart :: The Art of E-Commerce');
define('HEADER_LOGO_WIDTH', '200px');
define('HEADER_LOGO_HEIGHT', '70px');
define('HEADER_LOGO_IMAGE', 'logo.gif');

//
// regardez dans votre repertoire local $PATH_LOCALE/locale pour les variables disponibles.
