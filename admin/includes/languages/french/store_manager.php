 ...
 */
  ...
  define('TEXT_INFO_PURGE_DEBUG_LOG_FILES', '<strong>Nettoyage des fichiers Log de Debug</strong><br /><strong>ATTENTION: </strong>Zen Cart enregistre les messages d\'erreur PHP &agrave; des fins de d&eacute;buggage, et certains modules de paiement peuvent &ecirc;tre configur&eacute;s pour logguer des donn&eacute;es afin de diagnostiquer des probl&egrave;mes de communication. <br />Cliquer sur cette option de nettoyage supprimera *definitivement* *TOUS* les logs de debug contenant les erreurs PHP, et des modules PayPal, Authorize.net, et Linkpoint/FirstData.');
  define('SUCCESS_CLEAN_DEBUG_FILES', 'Les fichiers Log de Debug ont &eacute;t&eacute; supprim&eacute;s');
