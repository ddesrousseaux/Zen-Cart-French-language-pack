...
//
  ...
  define('NAVBAR_TITLE', 'Vie Priv&eacute;e');
  define('HEADING_TITLE', 'Vie Priv&eacute;e');

  define('TEXT_INFORMATION', 'Vous pouvez ecrire votre notice de confidentialite sur cette page.');
?>