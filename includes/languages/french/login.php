 ...
 */
  ...
  define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'En cr&eacute;ant votre compte client sur ' . STORE_NAME . ', vous conserverez la trace des commandes que vous avez r&eacute;alis&eacute;es et b&eacute;n&eacute;ficierez de services personnalis&eacute;s.');
  ...
  define('TEXT_VISITORS_CART', '<strong>Info :</strong> Si vous avez d&eacute;j&agrave; command&eacute; chez nous auparavant et avez laiss&eacute; quelque chose dans votre panier, pour votre confort, le contenu sera conserv&eacute; si vous vous identifiez &agrave; nouveau. <a href="javascript:session_win();">[En savoir plus]</a>');
