 ...
 */
  ...
  define('MODULE_PAYMENT_PAYPAL_MARK_BUTTON_ALT', 'Commander avec PayPal');
  ...
  define('MODULES_PAYMENT_PAYPALSTD_LINEITEM_TEXT_ONETIME_CHARGES_PREFIX', 'Taxes One-Time en relation avec ');
  define('MODULES_PAYMENT_PAYPALSTD_LINEITEM_TEXT_SURCHARGES_SHORT', 'Taxes');
  define('MODULES_PAYMENT_PAYPALSTD_LINEITEM_TEXT_SURCHARGES_LONG', 'G&egrave;re les charges et autres taxes applicables');
  define('MODULES_PAYMENT_PAYPALSTD_LINEITEM_TEXT_DISCOUNTS_SHORT', 'Remises');
  define('MODULES_PAYMENT_PAYPALSTD_LINEITEM_TEXT_DISCOUNTS_LONG', 'Cr&eacute;dits appliqu&eacute;s, y compris les codes de r&eacute;duction, ch&egrave;ques cadeaux, etc');
