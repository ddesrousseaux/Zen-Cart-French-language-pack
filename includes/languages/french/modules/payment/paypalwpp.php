...
'<font color="green"><hr /><strong>Configuration requise:</strong></font><br /><hr />*<strong>CURL</strong> est utilis&eacute; pour communiquer dans les deux sens avec la passerelle, il doit donc &ecirc;tre activ&eacute; sur votre serveur d\'h&eacute;bergement (si vous avez besoin d\'utiliser un proxy avec CURL, r&eacute;glez le dans les param&egrave;tres CURL sous Admin->Configuration->Ma boutique.)<br /><hr />' );
  ...
  define('MODULE_PAYMENT_PAYPALWPP_ERROR_AVS_FAILURE_TEXT', 'ALERTE: Echec de la v&eacute;rification d\'adresse. ');
  define('MODULE_PAYMENT_PAYPALWPP_ERROR_CVV_FAILURE_TEXT', 'ALERTE: Echec de la v&eacute;rification du code CVV de la carte. ');
  define('MODULE_PAYMENT_PAYPALWPP_ERROR_AVSCVV_PROBLEM_TEXT', ' la commande est en attente de v&eacute;rification par le propri&eacute;taire de la boutique.');
  define('MODULE_PAYMENT_PAYPALWPP_TEXT_UNILATERAL', ' - Vous devez vous enregistrer sur PayPal API avant de pouvoir faire des traitements de transaction avanc&eacute;s.');
...
////////////////////////////////////////
  ...
  define('MODULE_PAYMENT_PAYPAL_ENTRY_COMMENTS', 'Commentaires Syst&egrave;me: ');
...
// this text is used to announce the username/password when the module creates the customer account and emails data to them:
  ...
  define('MODULES_PAYMENT_PAYPALWPP_LINEITEM_TEXT_DISCOUNTS_LONG', 'Cr&eacute;dits appliqu&eacute;s, incluant les codes de r&eacute;duction, ch&egrave;que cadeau, etc');
