...
// Admin Configuration Items
  ...
  if (MODULE_PAYMENT_AUTHORIZENET_ECHECK_STATUS == 'True') {
    define('MODULE_PAYMENT_AUTHORIZENET_ECHECK_TEXT_DESCRIPTION', '<a target="_blank" href="https://account.authorize.net/">Authorize.net Login Marchands</a>');
  } else { 
 define('MODULE_PAYMENT_AUTHORIZENET_ECHECK_TEXT_DESCRIPTION', '<a target="_blank" href="http://reseller.authorize.net/application.asp?id=131345">Cliquez ici pour cr&eacute;er un compte</a><br /><br /><a target="_blank" href="https://account.authorize.net/">Authorize.net espace marchands</a><br /><br /><strong>N&eacute;cessite:</strong><br /><hr />*<strong>Un compte Authorize.net</strong> (see link above to signup)<br />*<strong>CURL est requis </strong>et doit &ecirc;trecompil&eacute; avec le support SSL par votre h&eacute;bergeur<br />*<strong>Nom d\'utilisateur Authorize.net et cl&eacute; de transaction</strong> disponible &agrave; partie de votre espace marchand');
  }
  define('MODULE_PAYMENT_AUTHORIZENET_ECHECK_TEXT_ERROR_CURL_NOT_FOUND', 'fonctions CURL non trouv&eacute;es - requises pour les paiements par Authorize.net');
