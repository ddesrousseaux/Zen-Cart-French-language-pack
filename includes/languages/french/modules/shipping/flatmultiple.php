...
define('MODULE_SHIPPING_FLATMULTIPLE_TEXT_TITLE', 'Forfait Multiple');
define('MODULE_SHIPPING_FLATMULTIPLE_TEXT_DESCRIPTION', 'Forfait de livraison Multiple');
define('MODULE_SHIPPING_FLATMULTIPLE_TEXT_WAY', 'Meilleure route');
