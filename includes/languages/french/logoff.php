 ...
 */
  ...
  define('TEXT_MAIN', 'Vous venez de quitter votre compte personnel.<br /><br />Merci de votre visite. Votre panier est sauvegard&eacute; et vous retrouverez son contenu lors de votre prochaine <a href="' . zen_href_link(FILENAME_LOGIN, '', 'SSL') . '"><span class="pseudolink">connexion</span></a>.');
?>
