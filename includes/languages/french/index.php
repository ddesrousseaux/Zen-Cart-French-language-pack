...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
  ...
  define('HEADING_TITLE', ''); /*A remplacer avec une phrase du genre Bienvenue dans Ma Boutique...!*/
} elseif ($category_depth == 'nested') {
  // this will also be used on Top Level
  define('HEADING_TITLE', 'Accueil'); /*A remplacer avec une phrase du genre Bienvenue dans Ma Boutique...!*/
}
?>
