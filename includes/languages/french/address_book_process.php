 ...
 */
  ...
  define('NAVBAR_TITLE_MODIFY_ENTRY', 'Actualiser l\'entr&eacute;e');
  define('NAVBAR_TITLE_DELETE_ENTRY', 'Supprimer l\'entr&eacute;e');

  define('HEADING_TITLE_ADD_ENTRY', 'Nouvelle entr&eacute;e');
  define('HEADING_TITLE_MODIFY_ENTRY', 'Actualiser l\'entr&eacute;e du carnet d\'adresse');
  define('HEADING_TITLE_DELETE_ENTRY', 'Supprimer l\'entr&eacute;e du carnet d\'adresse');
  define('HEADING_TITLE', 'Carnet d\'adresses');

  define('DELETE_ADDRESS_TITLE', 'Supprimer l\'adresse');
  define('DELETE_ADDRESS_DESCRIPTION', 'Etes-vous certain de vouloir supprimer l\'adresse s&eacute;lectionn&eacute;e de votre carnet d\'adresses ?');

  define('NEW_ADDRESS_TITLE', 'Nouvelle entr&eacute;e');
  ...
  define('WARNING_PRIMARY_ADDRESS_DELETION', 'L\'Adresse Principale ne peut pas &ecirc;tre suprim&eacute;e. Veuillez s&eacute;lectionner une autre adresse comme adresse principale, et recommencez.');
