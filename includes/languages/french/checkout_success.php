 ...
 */
  ...
  define('TEXT_SEE_ORDERS', 'Vous pouvez consulter votre historique de commandes en vous rendant sur la page <a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '"  name="linkMyAccount">Mon Compte</a> et en cliquant sur "Voir toutes les commandes".');
  define('TEXT_CONTACT_STORE_OWNER', 'Pour toute question concernant votre commande, merci de contacter notre <a href="' . zen_href_link(FILENAME_CONTACT_US) . '" name="linkContactUs">Service Clients</a>.');
